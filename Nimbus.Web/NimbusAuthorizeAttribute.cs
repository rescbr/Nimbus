...
namespace Nimbus.Web
{
    ...
    public class NimbusAuthorizeAttribute : AuthorizationFilterAttribute
    {
        ...
        protected virtual void HandleUnauthorizedRequest(HttpActionContext actionContext)
        {
            ...
            actionContext.Response = actionContext.ControllerContext.Request.CreateErrorResponse(HttpStatusCode.Unauthorized, "Not authorized");
        }
